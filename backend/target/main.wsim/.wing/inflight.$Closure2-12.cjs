...
module.exports = function({ $__parent_this_2_storage, $auth, $std_Json }) {
  class $Closure2 {
    constructor({  }) {
    ...
    async handle(req) {
      ...
      const order = (await $__parent_this_2_storage.get(id));
...
//# sourceMappingURL=inflight.$Closure2-12.cjs.map
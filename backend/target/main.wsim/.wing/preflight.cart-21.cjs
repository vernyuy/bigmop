...
class CartStorage extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.CartStorage-13.cjs")({
...
class CartService extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.CartService-13.cjs")({
      })
    `;
  }
  _toInflight() {
...
//# sourceMappingURL=preflight.cart-21.cjs.map
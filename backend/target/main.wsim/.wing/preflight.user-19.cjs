...
class UserStorage extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.UserStorage-11.cjs")({
...
class UserService extends $stdlib.std.Resource {
  constructor($scope, $id, storage, api, auth) {
    super($scope, $id);
    this.auth = auth;
    this.api = api;
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.UserService-11.cjs")({
      })
    `;
  }
  _toInflight() {
...
//# sourceMappingURL=preflight.user-19.cjs.map
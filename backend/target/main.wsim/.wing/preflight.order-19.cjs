...
const product = require("./preflight.product-17.cjs");
...
class OrderStorage extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.OrderStorage-11.cjs")({
...
class OrderService extends $stdlib.std.Resource {
  constructor($scope, $id, storage, prodStore, queue, api) {
    super($scope, $id);
    ...
    class $Closure1 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure1-11.cjs")({
    ...
    class $Closure2 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure2-11.cjs")({
    ...
    class $Closure3 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure3-11.cjs")({
    ...
    class $Closure4 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure4-11.cjs")({
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.OrderService-11.cjs")({
      })
    `;
  }
  _toInflight() {
...
//# sourceMappingURL=preflight.order-19.cjs.map
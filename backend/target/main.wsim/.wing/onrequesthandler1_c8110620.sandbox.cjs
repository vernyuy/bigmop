...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/Users/pro-3ie-s/Desktop/educloud/bigmop2/backend/target/main.wsim/.wing/inflight.$Closure2-9.cjs")({
            $__parent_this_2_productStorage: 
      (await (async () => {
        const ProductStorageClient = 
      require("/Users/pro-3ie-s/Desktop/educloud/bigmop2/backend/target/main.wsim/.wing/inflight.ProductStorage-9.cjs")({

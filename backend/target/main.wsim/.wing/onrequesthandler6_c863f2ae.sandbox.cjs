...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/Users/pro-3ie-s/Desktop/educloud/bigmop2/backend/target/main.wsim/.wing/inflight.$Closure1-12.cjs")({
            $__parent_this_1_counter: (function() {
  let handle = process.env.COUNTER_HANDLE_62808d01;
  if (!handle) {
    throw new Error("Missing environment variable: COUNTER_HANDLE_62808d01");
  }

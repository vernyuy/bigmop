...
var require_inflight_Closure1_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $Vite_sim, $cliFilename, $homeEnv, $openBrowser, $pathEnv, $props_generateTypeDefinitions, $props_publicEnv, $props_publicEnvName, $props_root, $props_typeDefinitionsFilename, $state }) {
      class $Closure1 {
        static {
...
// node_modules/@winglibs/vite/util.cjs
var require_util = __commonJS({
  "node_modules/@winglibs/vite/util.cjs"(exports2) {
    var PAYLOAD_PREFIX = "__WINGLIBS_VITE_0WgrTtVXAiskivf2cIM-Z__";
    exports2.stringifyPayload = (payload) => {
      return `${PAYLOAD_PREFIX}${JSON.stringify(payload)}`;
    };
    exports2.parsePayload = (payload) => {
      if (!payload.startsWith(PAYLOAD_PREFIX)) {
        return void 0;
      }
      return JSON.parse(payload.substring(PAYLOAD_PREFIX.length));
    };
    var { contentType } = require_mime_types();
    var { extname } = require("node:path");
    exports2.contentType = (filename) => {
      return contentType(extname(filename));
    };
  }
});

// node_modules/@winglibs/vite/vite.cjs
var require_vite = __commonJS({
  "node_modules/@winglibs/vite/vite.cjs"(exports2) {
    var { spawnSync, spawn } = require("node:child_process");
    var { parsePayload } = require_util();
    exports2.cliFilename = () => `${__dirname}/vite-cli.mjs`;
    exports2.build = (options) => {
      const args = [
        options.cliFilename,
        "build",
        "--options",
    ...
    exports2.dev = async (options) => {
      ...
      const kill = /* @__PURE__ */ __name(() => child.kill("SIGINT"), "kill");
...
// target/test/main.wsim/.wing/inflight.Vite_sim-1.cjs
var require_inflight_Vite_sim_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.Vite_sim-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({}) {
      class Vite_sim {
        static {
          __name(this, "Vite_sim");
        }
        constructor({}) {
        }
        static async dev(options) {
          return require_vite()["dev"](options);
        }
      }
      return Vite_sim;
    };
...
// target/test/main.wsim/.wing/service_c8b38155.sandbox.cjs
var $stop;
exports.start = async function() {
  ...
  const client = await await (async () => {
    const $Closure1Client = require_inflight_Closure1_1()({
      $Vite_sim: require_inflight_Vite_sim_1()({}),
      ...
      $props_typeDefinitionsFilename: void 0,
      $state: function() {
        let handle = process.env.STATE_HANDLE_8ab5ff8b;
        if (!handle) {
          throw new Error("Missing environment variable: STATE_HANDLE_8ab5ff8b");
        }
    ...
    const client2 = new $Closure1Client({});

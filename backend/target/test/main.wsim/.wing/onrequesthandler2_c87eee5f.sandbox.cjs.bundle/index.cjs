...
// target/test/main.wsim/.wing/inflight.$Closure3-9.cjs
var require_inflight_Closure3_9 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-9.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_3_productStorage, $std_Json }) {
      class $Closure3 {
        static {
...
// target/test/main.wsim/.wing/onrequesthandler2_c87eee5f.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure3Client = require_inflight_Closure3_9()({

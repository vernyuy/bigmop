...
// target/test/main.wsim/.wing/inflight.$Closure1-9.cjs
var require_inflight_Closure1_9 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-9.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_1_productStorage, $std_Json }) {
      class $Closure1 {
        static {
...
// target/test/main.wsim/.wing/inflight.ProductStorage-9.cjs
var require_inflight_ProductStorage_9 = __commonJS({
  "target/test/main.wsim/.wing/inflight.ProductStorage-9.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
...
// target/test/main.wsim/.wing/onrequesthandler0_c84f1e07.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure1Client = require_inflight_Closure1_9()({
          $__parent_this_1_productStorage: await (async () => {
            const ProductStorageClient = require_inflight_ProductStorage_9()({
              $Product: require_json_schema().JsonSchema._createJsonSchema({ "$id": "/Product", "type": "object", "properties": { "id": { "type": "string" }, "imageUrl": { "type": "string" }, "name": { "type": "string" }, "price": { "type": "number" }, "qty": { "type": "number" } }, "required": ["id", "imageUrl", "name", "price", "qty"] }),

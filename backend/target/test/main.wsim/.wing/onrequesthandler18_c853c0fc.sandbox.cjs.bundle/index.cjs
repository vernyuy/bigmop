...
// target/test/main.wsim/.wing/inflight.$Closure1-16.cjs
var require_inflight_Closure1_16 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-16.cjs"(exports2, module2) {
    "use strict";
...
// target/test/main.wsim/.wing/onrequesthandler18_c853c0fc.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure1Client = require_inflight_Closure1_16()({
          $counter: function() {

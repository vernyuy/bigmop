...
// target/test/main.wsim/.wing/inflight.$Closure1-14.cjs
var require_inflight_Closure1_14 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-14.cjs"(exports2, module2) {
    "use strict";
...
// target/test/main.wsim/.wing/onrequesthandler9_c8282ed7.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure1Client = require_inflight_Closure1_14()({
          $counter: function() {

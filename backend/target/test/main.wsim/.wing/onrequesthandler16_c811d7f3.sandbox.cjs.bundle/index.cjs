...
// target/test/main.wsim/.wing/inflight.$Closure2-15.cjs
var require_inflight_Closure2_15 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-15.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_2_cartStorage, $std_Json }) {
      class $Closure2 {
        static {
...
// target/test/main.wsim/.wing/onrequesthandler16_c811d7f3.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure2Client = require_inflight_Closure2_15()({
          $__parent_this_2_cartStorage: await (async () => {

...
// target/test/main.wsim/.wing/inflight.$Closure3-15.cjs
var require_inflight_Closure3_15 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-15.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_3_cartStorage, $std_Json }) {
      class $Closure3 {
        static {
...
// target/test/main.wsim/.wing/inflight.CartStorage-15.cjs
var require_inflight_CartStorage_15 = __commonJS({
  "target/test/main.wsim/.wing/inflight.CartStorage-15.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
...
// target/test/main.wsim/.wing/onrequesthandler17_c835ba7d.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure3Client = require_inflight_Closure3_15()({
          $__parent_this_3_cartStorage: await (async () => {
            ...
            const client2 = new CartStorageClient({
              $this_counter: function() {
                let handle = process.env.COUNTER_HANDLE_99b6a4f4;
                if (!handle) {
                  throw new Error("Missing environment variable: COUNTER_HANDLE_99b6a4f4");
                }
              ...
              $this_db: function() {
                let handle = process.env.TABLE_HANDLE_90d8e3d9;
                if (!handle) {
                  throw new Error("Missing environment variable: TABLE_HANDLE_90d8e3d9");
                }
                const simulatorUrl = process.env.WING_SIMULATOR_URL;
                if (!simulatorUrl) {
                  throw new Error("Missing environment variable: WING_SIMULATOR_URL");

...
// target/test/main.wsim/.wing/inflight.$Closure3-11.cjs
var require_inflight_Closure3_11 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-11.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_3_userStorage, $std_Json }) {
      class $Closure3 {
        static {
...
// target/test/main.wsim/.wing/inflight.UserStorage-11.cjs
var require_inflight_UserStorage_11 = __commonJS({
  "target/test/main.wsim/.wing/inflight.UserStorage-11.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $User, $std_Number }) {
      class UserStorage {
        static {
        ...
        async add(user) {
          ...
          const userJson = { "id": id, "firstName": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "firstName"), "lastName": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "lastName"), "dob": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "dob"), "email": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "email"), "username": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "username"), "imageUrl": ((obj, args) => {
            if (obj[args] === void 0)
              throw new Error(`Json property "${args}" does not exist`);
            return obj[args];
          })(user, "imageUrl") };
...
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure3Client = require_inflight_Closure3_11()({
          $__parent_this_3_userStorage: await (async () => {
            const UserStorageClient = require_inflight_UserStorage_11()({
              $User: require_json_schema().JsonSchema._createJsonSchema({ "$id": "/User", "type": "object", "properties": { "dob": { "type": "string" }, "email": { "type": "string" }, "firstName": { "type": "string" }, "id": { "type": "string" }, "imageUrl": { "type": "string" }, "lastName": { "type": "string" }, "username": { "type": "string" } }, "required": ["dob", "email", "firstName", "id", "imageUrl", "lastName", "username"] }),
              $std_Number: require_number().Number
            });
            const client2 = new UserStorageClient({

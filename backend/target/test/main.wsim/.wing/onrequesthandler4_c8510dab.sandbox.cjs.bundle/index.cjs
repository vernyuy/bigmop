...
// target/test/main.wsim/.wing/inflight.$Closure2-11.cjs
var require_inflight_Closure2_11 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-11.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_2_userStorage, $std_Json }) {
      class $Closure2 {
        static {
...
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure2Client = require_inflight_Closure2_11()({
          $__parent_this_2_userStorage: await (async () => {
